...
<head>
    ...
    <title>Enlace invalido | ATLANTIDA</title>
</head>
...
<body>
    ...
    <div class="container mx-auto px-4 py-40 flex flex-col items-center justify-center">
        ...
        <h1 class="text-3xl font-bold mb-4">El <span
            ...
            erróneamente o no existe.</h1>
        <h3 class="text-lg">Por favor, verifica que el enlace sea correcto o solicita uno nuevo.</h3>
        <div>
