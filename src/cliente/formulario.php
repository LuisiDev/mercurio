                ...
                <form id="ratingForm" action="../procesos/form-calificacion.php" method="POST"
                    ...
                    <div class="p-5">
                        ...
                        <div class="w-4/5 lg:w-1/2 mx-auto mb-6">
                            <div class="mb-6">
                                <h2 class="text-2xl font-bold mb-3 text-center">Firma de finalización de servicio
                                </h2>
                                <h2 class="text-2xl font-medium mb-6 text-center">Ticket #<?php echo $idTicket; ?> -
                                    <?php echo $asunto; ?>
                                </h2>
                                ...
                                <div>
                                    ...
                                    <div class="flex justify-center mb-4">
                                        <input type="button" onclick="enableSubmit()"
                                        ...
                                        <div class="p-2"></div>
                                        <input type="button" onclick="disableSubmit()"
                                ...
                                <!-- Botón para aparecer el formulario -->
                                <div class="flex justify-center mt-6" id="showForm">
                                    <a type="button" onclick="showForm()"
                                        class="px-3 py-2 cursor-pointer text-sm font-medium text-center inline-flex items-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24">
                                            <g fill="none" stroke="currentColor" stroke-linecap="round"
                                                ...
                                                <path stroke-dasharray="6" stroke-dashoffset="6" stroke-width="1"
                                                    d="M6 15l3 3">
                                                    <animate fill="freeze" attributeName="stroke-dashoffset"
                                ...
                                <div class="hidden mt-6 flex justify-center" id="hideForm">
                                    <a type="button" onclick="hideForm()"
                                ...
                                <div class="flex flex-col items-center mt-6" id="textFormContainer">
                                    <p class="text-gray-600 text-center">Nos ayudarías a mejorar respondiendo el
                                        formulario
                                        de
                                        finalización
                                        del servicio. Recuerda que este formulario es opcional, pero nos ayudarías mucho
                                        con
                                        tus
                            ...
                            <div class="hidden mt-6" id="formContainer">
                                <div>
                                    <div class="mb-6">
                                    ...
                                    <div class="mb-4">
                                        <div class="text-medium w-full mb-2">
                                            <p class="text-gray-600">¿Cómo calificaría el servicio que se le dió?
                                    ...
                                    <div class="mb-4">
                                        <div class="text-medium w-full mb-2">
                                            <p class="text-gray-600">¿Qué tan satisfecho se encuentra con las
                                                evidencias?
                                                <span class="text-sm font-medium text-gray-500">(Opcional)</span>
                                            </p>
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        <div class="text-medium w-full mb-2">
                                            <p class="text-gray-600">¿Se encuentra en acuerdo o en desacuerdo con que tu
                                                problema fue resuelto efectivamente?
                                                <span class="text-sm font-medium text-gray-500">(Opcional)</span>
                                            </p>
                                        </div>
                                        <div>
                                            ...
                                            <div class="my-4">
                                                <label for="message"
                                                    class="block mb-2 text-sm font-medium text-gray-900">Explique el
                                                    motivo
                                ...
                                <div>
                                    ...
                                    <div class="mb-4">
                                        <div class="text-medium w-full mb-2">
                                            <p class="text-gray-600">¿Cómo fue la atención que recibió de parte del
                                                técnico?
                                                <span class="text-sm font-medium text-gray-500">(Opcional)</span>
                                            </p>
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="mb-4">
                                        <div class="text-medium w-full mb-2">
                                            <p class="text-gray-600">¿Qué tan satisfecho se encuentra con el producto?
                                                <span class="text-sm font-medium text-gray-500">(Opcional)</span>
                                            </p>
                                        </div>
                                        <div class="star-container">
                                    ...
                                    <div class="mb-4">
                                        <div class="text-medium w-full mb-2">
                                            <p class="text-gray-600">¿Con qué frecuencia utilizas el producto o
                                                servicio?
                                                <span class="text-sm font-medium text-gray-500">(Opcional)</span>
                                            </p>
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="mb-4">
                                        <div class="text-medium w-full mb-2">
                                            <p class="text-gray-600">¿Cuál sería una palabra que usarias para
                                                describirnos y
                                                por
                                                qué?</p>
                                        </div>
                            ...
                            <div class="mt-10">
                                <button type="button" onclick="reload()"
                                    class="py-2.5 px-5 me-2 mb-2 cursor-pointer text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Limpiar
                                    registro</button>
                                <button type="submit" id="submitForm"
                                    class="text-white bg-blue-900 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 cursor-not-allowed"
                                    disabled>Enviar
                                    formulario</button>
                            </div>

                            <script>
                                // Quitar disabled y la clase cursor-not-allowed de #submitForm al dar click en draw-subitBtn
                                function enableSubmit() {
                                    document.getElementById('submitForm').removeAttribute('disabled');
                                    document.getElementById('submitForm').classList.remove('cursor-not-allowed');
                                    document.getElementById('submitForm').classList.add('cursor-pointer');
                                    document.getElementById('submitForm').classList.remove('bg-blue-900');
                                    document.getElementById('submitForm').classList.add('bg-blue-700');
                                    document.getElementById('submitForm').classList.add('hover:bg-blue-800');
                                }

                                function disableSubmit() {
                                    document.getElementById('submitForm').setAttribute('disabled', 'disabled');
                                    document.getElementById('submitForm').classList.add('cursor-not-allowed');
                                    document.getElementById('submitForm').classList.remove('cursor-pointer');
                                    document.getElementById('submitForm').classList.remove('bg-blue-700');
                                    document.getElementById('submitForm').classList.add('bg-blue-900');
                                    document.getElementById('submitForm').classList.remove('hover:bg-blue-800');
                                }
                            </script>
