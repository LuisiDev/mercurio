        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿Estás seguro que deseas eliminar
                    el ticket #<span id="dynamicTicketId"><?php echo htmlspecialchars($fila['idTicket']); ?></span>?
                </h3>
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                    Eliminación de ticket #<span
                        id="dynamicTicketIdDelete"><?php echo htmlspecialchars($fila['idTicket']); ?></span>
                </h3>
                <button type="button"
    ...
    function eliminarTicket() {
        ...
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4) {
                ...
                window.location.href = '../web/gestion.php';
            }
        };
