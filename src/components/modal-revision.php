        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div class="p-4 pt-0">
                <div inline-datepicker datepicker-autoselect-today
                    ...
                    <input type="text" class="hidden" id="datepicker-input" />
                </div>
                ...
                <div class="grid grid-cols-2 gap-2">
                    <button type="button" id="guardar-revision"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" data-modal-hide="revision-modal">Guardar</button>
