    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                ...
                <p class="text-gray-200 text-sm ml-2 font-medium">Miembro de <span class="">Grupo Cardinales</span></p>
                ...
                <p class="text-gray-200 text-md ml-2 flex mt-2 font-medium">
                    ...
                    Calle Don Antonio Suárez Gutiérrez, Fondeport, 28219, Manzanillo, Colima.
                </p>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-white uppercase dark:text-white">Recursos</h2>
                ...
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-white uppercase dark:text-white">Plataformas</h2>
                    <ul class="text-gray-200 dark:text-gray-400 font-medium">
                        <li class="mb-4">
                            <a href="https://github.com/themesberg/flowbite" class="hover:underline ">ATL Integral</a>
                        </li>
                        <li>
                ...
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-white uppercase dark:text-white">Ayuda</h2>
                    <ul class="text-gray-200 dark:text-gray-400 font-medium">
                        <li class="mb-4">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-50 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/"
                    class="hover:underline">ATLANTIDA™</a>. All Rights Reserved.
            </span>
