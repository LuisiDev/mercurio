...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (($tipoArchivo == "jpg" || $tipoArchivo == "png" || $tipoArchivo == "jpeg") && $_FILES["imagen"]["size"] <= 20000000) {
    ...
    $stmt->bind_param('sssssssss', $user, $nombre, $apellido, $email, $rutaArchivo, $tipo, $password, $userStatus, $fhCreacion);
    $stmt->execute();
