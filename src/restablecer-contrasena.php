            ...
            <div
                ...
                <div id="login-form" class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form action="procesos/restablecer-contrasena.php" method="POST" class="space-y-4 md:space-y-6">
                        ...
                        <button type="submit"
                            class="w-full text-white bg-blue-700 hover:bg-primary-900 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Entrar</button>
                    </form>
