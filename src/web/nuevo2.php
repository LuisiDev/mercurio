        ...
        <div class="p-4">
            ...
            <div class="grid grid-cols-1 gap-4 mb-4">
                <div class="max-w-full w-full h-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
                    ...
                    <form action="../procesos/nuevo.php" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="mb-5">
                            ...
                            <select name="servicio" id="servicio"
                                ...
                                <option value="Cambio SIM">Cambio de SIM</option>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-2">
                                ...
                                <!-- Concepto A -->
                                <div id="concepto-collapse" data-accordion="collapse">
                                    <h2 id="concepto-collapse-heading-a">
                                        <button type="button"
                                            class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3"
                                            data-accordion-target="#concepto-collapse-body-a"
                                            aria-controls="concepto-collapse-body-a">
                                            <span>Concepto A</span>
                                            <div class="flex items-center gap-3 rtl:gap-reverse">
                                                <span
                                                    class="inline-flex items-center justify-center w-3 h-3 p-3.5 ms-3 text-sm font-medium text-blue-700 bg-blue-200 rounded-full dark:bg-blue-900 dark:text-blue-300">0</span>
                                    ...
                                    <div id="concepto-collapse-body-a" class="hidden"
                                        aria-labelledby="concepto-collapse-heading-a">
                                        <div
                                            class="p-5 flex border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                                    ...
                                    <!-- Fin Concepto A -->
                                    <!-- Concepto B -->
                                    <h2 id="concepto-collapse-heading-b">
                                        <button type="button"
                                            class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3"
                                            data-accordion-target="#concepto-collapse-body-b" aria-expanded="false"
                                            aria-controls="concepto-collapse-body-b">
                                    ...
                                    <div id="concepto-collapse-body-b" class="hidden"
                                        aria-labelledby="concepto-collapse-heading-b">
                                        <div
                                            class="p-5 flex border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                                            <div class="flex items-center me-3">
                                                <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">
                                                    Instalación remolque
                                                </h2>
                                            </div>
                                            <div class="relative flex items-center max-w-[11rem]">
                                                ...
                                                <div
                                                    ...
                                                    <svg class="w-2.5 text-gray-400" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 22 22">
                                    ...
                                    <!-- Fin Concepto B -->
                                    <!-- Concepto C -->
                                    <h2 id="concepto-collapse-heading-c">
                                        <button type="button"
                                            class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3"
                                            data-accordion-target="#concepto-collapse-body-c" aria-expanded="false"
                                            aria-controls="concepto-collapse-body-c">
                                            <span>Concepto C</span>
                                            <div class="flex items-center gap-3 rtl:gap-reverse">
                                                <span
                                                    class="inline-flex items-center justify-center w-3 h-3 p-3.5 ms-3 text-sm font-medium text-blue-700 bg-blue-200 rounded-full dark:bg-blue-900 dark:text-blue-300">0</span>
                                                <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0"
                                    ...
                                    <div id="concepto-collapse-body-c" class="hidden"
                                        aria-labelledby="concepto-collapse-heading-c">
                                        <div
                                            class="p-5 flex border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                                            <div class="flex items-center me-3">
                                                <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">
                                    ...
                                    <!-- Fin Concepto C -->
                                    <!-- Concepto D -->
                                    <h2 id="concepto-collapse-heading-d">
                                        <button type="button"
                                            class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3"
                                            data-accordion-target="#concepto-collapse-body-d" aria-expanded="false"
                                            aria-controls="concepto-collapse-body-d">
                                            <span>Concepto D</span>
                                            <div class="flex items-center gap-3 rtl:gap-reverse">
                                                <span
                                                    class="inline-flex items-center justify-center w-3 h-3 p-3.5 ms-3 text-sm font-medium text-blue-700 bg-blue-200 rounded-full dark:bg-blue-900 dark:text-blue-300">0</span>
                                                <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0"
                                    ...
                                    <div id="concepto-collapse-body-d" class="hidden"
                                        aria-labelledby="concepto-collapse-heading-d">
                                        <div
                                            class="p-5 flex border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                                            <div class="flex items-center me-3">
                                                <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">
                                    ...
                                    <!-- Fin Concepto D -->
                                    <!-- Concepto E -->
                                    <h2 id="concepto-collapse-heading-e">
                                        <button type="button"
                                            class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3"
                                            data-accordion-target="#concepto-collapse-body-e" aria-expanded="false"
                                            aria-controls="concepto-collapse-body-e">
                                            <span>Concepto E</span>
                                            <div class="flex items-center gap-3 rtl:gap-reverse">
                                                <span
                                                    class="inline-flex items-center justify-center w-3 h-3 p-3.5 ms-3 text-sm font-medium text-blue-700 bg-blue-200 rounded-full dark:bg-blue-900 dark:text-blue-300">0</span>
                                                <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0"
                                    ...
                                    <div id="concepto-collapse-body-e" class="hidden"
                                        aria-labelledby="concepto-collapse-heading-e">
                                        <div
                                            class="p-5 flex border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                                            <div class="flex items-center me-3">
                                                <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">
                                    ...
                                    <!-- Fin Concepto E -->
                                    <!-- Concepto F -->
                                    <h2 id="concepto-collapse-heading-f">
                                        <button type="button"
                                            class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3"
                                            data-accordion-target="#concepto-collapse-body-f" aria-expanded="false"
                                            aria-controls="concepto-collapse-body-f">
                                            <span>Concepto F</span>
                                            <div class="flex items-center gap-3 rtl:gap-reverse">
                                                <span
                                                    class="inline-flex items-center justify-center w-3 h-3 p-3.5 ms-3 text-sm font-medium text-blue-700 bg-blue-200 rounded-full dark:bg-blue-900 dark:text-blue-300">0</span>
                                                <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0"
                                    ...
                                    <div id="concepto-collapse-body-f" class="hidden"
                                        aria-labelledby="concepto-collapse-heading-f">
                                        <div
                                            class="p-5 flex border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                                            <div class="flex items-center me-3">
                                                <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">
                                    ...
                                    <!-- Fin Concepto F -->
                                    <!-- Concepto G -->
                                    <h2 id="concepto-collapse-heading-g">
                                        <button type="button"
                                            class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3"
                                            data-accordion-target="#concepto-collapse-body-g" aria-expanded="false"
                                            aria-controls="concepto-collapse-body-g">
                                            <span>Concepto G</span>
                                            <div class="flex items-center gap-3 rtl:gap-reverse">
                                                <span
                                                    class="inline-flex items-center justify-center w-3 h-3 p-3.5 ms-3 text-sm font-medium text-blue-700 bg-blue-200 rounded-full dark:bg-blue-900 dark:text-blue-300">0</span>
                                                <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0"
                                    ...
                                    <div id="concepto-collapse-body-g" class="hidden"
                                        aria-labelledby="concepto-collapse-heading-g">
                                        <div
                                            class="p-5 flex border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                                            <div class="flex items-center me-3">
                                                <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">
                        ...
                        <div class="mb-5">
                            <label for="address"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Domicilio
                                o URL de
                                ubicación</label>
                        ...
                        <img id="output" class="mx-auto h-32 w-32 object-cover my-8 hidden"
                            onclick="showImageEvidence(this)" alt="Visualización de evidencia">
                        <div class="mb-5">
