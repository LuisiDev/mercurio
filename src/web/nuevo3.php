...
<body class="bg-gray-50 dark:bg-gray-700">
            ...
            <div class="grid grid-cols-1 gap-4 mb-4">
                <div class="max-w-full w-full h-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
                    ...
                    <form action="../procesos/nuevo.php" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="mb-5 hidden" id="dispositivos">
                                ...
                                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM articulos WHERE artStatus = 0 AND categoria = '1'";
                                            ...
                                            while ($row = $result->fetch_assoc()): ?>
                                                <tr
                                                    ...
                                                    <td
                                                        class="px-6 py-4 font-semibold dark:text-white text-gray-900 whitespace-nowrap bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                        <?php echo $row['marca'] ?: 'No proporcionado'; ?>
                                                    </td>
                                                    <td
                                                        class="px-6 py-4 font-semibold dark:text-white text-gray-900 whitespace-nowrap bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                        <div class="flex items-center">
                        ...
                        <div class="mb-5 hidden" id="accesorios">
                            ...
                            <div class="inline-flex">
                                <div
                                    class="flex mr-1.5 items-center px-4 border border-gray-200 rounded-sm dark:border-gray-700">
                                ...
                                <div
                                    class="flex items-center px-4 p border border-gray-200 rounded-sm dark:border-gray-700">
                            ...
                            <div class="p-5 border-dashed border-2 border-gray-300 dark:border-gray-600 rounded-lg hidden" id="table-accesorios">
                                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                                    <table
                                        class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400"
                                        id="articulos-table">
    ...
    <script>
        ...
        document.getElementById('bordered-radio-1').addEventListener('click', function() {
            const showAccesorios = document.getElementById('table-accesorios');
            showAccesorios.classList.remove('hidden');
        });
