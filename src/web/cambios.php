...
<body class="bg-gray-50 dark:bg-gray-700">
    ...
    <div class="p-4 lg:mb-4 sm:ml-64">
        <div class="p-3">
            ...
            <div>
                <h2 class="font-normal text-xl text-gray-500 dark:text-gray-400 mb-2">Hoy</h2>
            </div>
                ...
                <div class="w-full flex justify-between px-4 py-4 mb-4 bg-white dark:bg-gray-800 rounded-lg shadow">
                    ...
                    <div class="flex items-center">
                        <div class="flex justify-between">
                            ...
                            <div>
                                <h5 class="leading-none text-sm font-normal text-gray-900 dark:text-white pb-1">
                    ...
                    <div class="flex space-x-4">
                        <button
                            class="flex items-center justify-center w-10 h-10 bg-gray-200 dark:bg-gray-700 rounded-full">
